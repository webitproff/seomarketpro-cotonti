...
$L['cfg_seomarketpro_currency'] = 'Валюта в разметке';
...
$L['info_notes'] = 'Требуется: модуль <a href="https://github.com/webitproff/marketpro-cotonti" target="_blank"><strong>Market PRO v.5+ by webitproff</strong></a>, PHP 8.4+, MySQL 8.0+, Cotonti Siena v.0.9.26 +';


$L['seomarketpro_related'] = 'Связанные и похожие товары';
$L['seomarketpro_read_time'] = 'минут чтения';
$L['seomarketpro_unknown_author'] = 'Неизвестный продавец';
$L['seomarketpro_stop_words'] = 'и,в,на,с,по,для,это,как,что,а,у,к,от,до,а,без,более,бы,был,была,были,было,быть,в,вам,вас,весь,во,вот,все,всего,всех,вы,где,да,даже,для,до,его,ее,если,есть,еще,же,за,здесь,и,из,или,им,их,к,как,когда,кто,ли,либо,мне,может,мы,на,надо,наш,не,него,нее,нет,ни,них,но,ну,о,об,однако,он,она,они,оно,от,перед,по,под,после,потом,потому,почти,при,про,раз,разве,с,сам,свое,свои,себе,себя,сей,сколько,со,совсем,так,там,те,тем,теперь,то,того,тоже,той,только,том,ты,у,уже,хотя,чего,чей,чем,что,чтобы,чье,чья,эта,эти,это,я,всё,меня,чтобы,потом,они,если,тут,сразу,что-то';
