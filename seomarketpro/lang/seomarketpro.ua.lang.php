 ...
 * Filename: seomarketpro.uk.lang.php
...
$L['cfg_nonlogo_hint'] = 'plugins/seomarketpro/logo.webp (без домену)';

$L['cfg_nonimage'] = 'Шлях до зображення за замовчуванням';
$L['cfg_nonimage_hint'] = 'plugins/seomarketpro/image.webp (без домену)';
